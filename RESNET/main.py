...
def parse_args():
    ...
    parser.add_argument('--res_n', type=int, default=50,choices=[18,34,50,101,152])
    ...
    parser.add_argument('--dataset_dir', type=str, default='c:/users/sf-1300f14mg/dki/sdams/dataset_20000.npy', help='you should load "*.npy" image dataset')
